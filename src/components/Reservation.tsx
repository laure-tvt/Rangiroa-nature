...
type FormData = { name: string; email: string; phone: string; project: string; budget: string; message: string }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-14 items-start">
          ...
          <div className="lg:col-span-2">
            ...
            >
              Parlons de<br /><span style={{ color: '#6F4F28' }}>votre projet.</span>
            </h2>
            <p
              data-reveal
              data-delay="180"
