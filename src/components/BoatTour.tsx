...
const steps = [
  {
    num: '01', icon: Search, title: 'Recherchez',
    desc: 'Explorez des milliers de biens en vente et en location à travers tous les archipels de Polynésie française.',
  },
  {
    num: '02', icon: Eye, title: 'Visitez',
    desc: "Prenez contact avec notre réseau d'agents locaux et organisez vos visites rapidement et facilement.",
  },
  {
    num: '03', icon: FileCheck, title: 'Signez',
    desc: "Finalisez votre acquisition en toute sécurité avec l'accompagnement de nos conseillers juridiques certifiés.",
  },
]

const areas = [
  { name: 'Tahiti', sub: 'Iles du Vent', count: '482 biens', img: 'https://images.unsplash.com/photo-1589197331516-4d84b72ebde3?w=600&q=80' },
  { name: 'Moorea', sub: 'Iles du Vent', count: '218 biens', img: 'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=600&q=80' },
  { name: 'Bora Bora', sub: 'Iles Sous-le-Vent', count: '176 biens', img: 'https://images.unsplash.com/photo-1583418855168-26fb64b8fe47?w=600&q=80' },
  { name: 'Rangiroa', sub: 'Tuamotu', count: '94 biens', img: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=600&q=80' },
]
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {steps.map((s, i) => (
              ...
              >
                ...
                <div style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '10px', fontWeight: 700, color: 'rgba(111,79,40,0.65)', letterSpacing: '0.14em', marginBottom: '8px', textTransform: 'uppercase' }}>
                  Étape {s.num}
                </div>
      ...
      <section id="secteurs" className="py-24 px-6" style={{ backgroundColor: '#000000' }}>
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <div>
              <div data-reveal className="section-label">Destinations</div>
              <h2
                data-reveal
                data-delay="100"
                style={{ fontFamily: 'Montserrat, sans-serif', fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 800, color: '#ffffff', lineHeight: 1.1 }}
              >
            ...
            <button
              data-reveal
              data-delay="150"
              style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '13px', color: '#6F4F28', background: 'none', border: 'none', cursor: 'pointer', textDecoration: 'underline', textUnderlineOffset: '3px', fontWeight: 600 }}
            >
